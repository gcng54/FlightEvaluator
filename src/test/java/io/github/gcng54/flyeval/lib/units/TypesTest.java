...
public class TypesTest {
    ...
    public class ETypesNewTest {
        ...
        void testVelocityWithinBounds() {
            Speed s = Speed.ofMeterPerHr(25.0);
        ...
        void testVelocityBelowLowerBound() {
            Speed s = Speed.ofMeterPerHr(-10.0);
    ...
    public class ETypesTest {
        ...
        void testSpeedConversion() {
            Speed s1 = Speed.ofKilometerPerHr(36.0);
        ...
        void testSpeedMultiplyTimeGivesLength() {
            Speed s = Speed.ofKilometerPerHr(10.0);
            Timer t = Timer.ofHour(100.0);
        ...
        void testTemperatureConversion() {
            Temperature tC = Temperature.ofCelsius(0.0);
            
            Temperature tF = Temperature.ofFahrenheit(32.0);
            Temperature tK = Temperature.ofKelvin(273.15);
